...
export class Lucidao__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class Lucidao extends ethereum.SmartContract {
  static bind(address: Address): Lucidao {
    return new Lucidao("Lucidao", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): Lucidao__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<Lucidao__checkpointsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<Lucidao__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<Lucidao__checkpointsResultValue0Struct>(value[0].toTuple())
    );
  }
